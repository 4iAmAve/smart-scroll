/*! smartScroll.js - v0.0.1 - 2015-09-14
* Copyright (c) 2015 Ave; Licensed MIT */
...
;(function(name, definition) {
  ...
  var smartScroll = function(data) {
    if( ! (this instanceof smartScroll))
      return new smartScroll(data);
    var self = this;
    ...
    var defaults = {
      ...
      no_data_class: 'smartScroll-no-data',
  ...
  smartScroll.prototype = {
    ...
    renderExtraTag: function(class_name, height) {
      var tag = document.createElement(this.options.tag),
        smartScroll_prefix = 'smartScroll-';
      tag.className = [smartScroll_prefix + 'extra-row', smartScroll_prefix + class_name].join(' ');
